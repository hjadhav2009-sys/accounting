...
export function ReportWorkspace() {
  ...
  const query = useMemo(() => { const value = new URLSearchParams(); if(dates.date_from)value.set("date_from",dates.date_from); if(dates.date_to)value.set("date_to",dates.date_to); return value.toString(); }, [dates]);
